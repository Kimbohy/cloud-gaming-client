...
class WebRTCAudioWorkletProcessor extends AudioWorkletProcessor {
  constructor() {
    ...
    this.maxQueueMs = 80; // Slightly increased for stability on slow devices
   ...
   */
  resample(input, fromRate, toRate, channels) {
